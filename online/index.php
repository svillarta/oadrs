      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
            <form class="form" method="post" action="build/login.php">
                ...
                <div class="card-body ">
                  <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="username" placeholder="User Name or Student ID" required>
                    </div>
                  </span>
                  <span class="bmd-form-group">
                    <div class="input-group">
                  ...
                  <div class="card-footer col-md-12 pull-left">
                    <a href="" class="btn btn-rose btn-link">Forgot password</a>
                    <button  class="btn btn-rose  btn-sm" >Lets Go</button>
                  </div>
                </div>
