      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Create Request</a>
          </div>
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="row container-fluid">
                    <div class="form-check mr-auto col">
                      <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" id="TOR" value="TRANSCRIPT OF RECORD" required="" aria-required="true"> TRANSCRIPT OF RECORD
                        <span class="form-check-sign">
                          <span class="check"></span>
                        </span>
                      </label>
                      
                      <div class="form-group select-wizard" id="TOR-Purpose1"><hr>
                        <label>(TOR)Purpose</label>
                        <div class="dropdown bootstrap-select">
                          <select class="selectpicker" id="TOR-Purpose" data-size="7" data-style="select-with-transition" title="Single Select" tabindex="-98">
                    ...
                    <div class="form-check mr-auto col">
                      <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" id="COG" value="CERTIFICATE OF GRADES" required="" aria-required="true"> CERTIFICATE OF GRADES
                        <span class="form-check-sign">
                          <span class="check"></span>
                        </span>
                      </label>
                    ...
                    <div class="form-check mr-auto col">
                      <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" id="G" value="GOODMORAL" required="" aria-required="true"> GOODMORAL
                        <span class="form-check-sign">
                          <span class="check"></span>
                        </span>
                      </label>
                    ...
                    <div class="form-check mr-auto col">
                      <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" id="HD" value="HONORABLE DISMISSAL" required="" aria-required="true"> HONORABLE DISMISSAL
                        <span class="form-check-sign">
                          <span class="check"></span>
                        </span>
                      </label>
                    ...
                    <div class="form-check mr-auto col">
                      <label class="form-check-label">
                        <input class="form-check-input" type="checkbox" id="TC" value="TRANSFER CODINTIAL" required="" aria-required="true"> TRANSFER CODINTIAL
                        <span class="form-check-sign">
                          <span class="check"></span>
                        </span>
                      </label>
                  ...
                  <div class="box-footer clearfix" >
                    ...
                    <button type="submit" class="pull-right btn btn-primary" name="osr" id="submit"><i class="fa fa-share-square"></i>  Save </button>
                  </div>
...
function myFunction(){
  if (document.getElementById('TOR').checked == true && document.getElementById('COG').checked == true && document.getElementById('HD').checked == true && document.getElementById('G').checked == false) {
...
$('#TC').on('click',function(){
  if (document.getElementById('TC').checked) {
    ...
    document.getElementById("TOR").checked = true;
...
<script type="text/javascript">
  $('#submit').on('click',function(event){
    ...
    if (document.getElementById('TOR').checked == true) {
      ...
      if (purpose == null) {
        ...
        $.ajax({  
          ...
          type:"post",  
          data:{request:request,purpose:purpose},
          beforeSend: function(){
            $('#loading').show();
            $('#submit').hide();
          },    
    ...
    if (document.getElementById('COG').checked == true) {
      var request = $('#COG').val();
      var purpose = '';
      $.ajax({  
          url:"../ajax/request.php",
    ...
    // var request = $('#rquest').val();
    // var purpose = $('#purpose').val();
    // if (request =='') {
    //   Swal.fire({
    //         icon: 'info',
    //         title: 'Oops...',
    //         text: 'please select request',
    //         footer: ''
    //       })
    // }else if(purpose ==''){
    //   Swal.fire({
    //         icon: 'info',
    //         title: 'Oops...',
    //         text: 'What is the porpuse of getting this document?',
    //         footer: ''
    //       })
    // }else{
    //   $.ajax({  
