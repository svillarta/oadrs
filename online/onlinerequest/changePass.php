...
<head>
  ...
  <link rel="stylesheet" href="../../assets/css/jquery-password-validator.css">
...
<body class="">
                ...
                <div class="card ">
                  ...
                  <div class="card-body ">
                    <div class="form-group">
                      <label for="" class="bmd-label-floating"> Old Password *</label>
                      <input type="password" class="form-control" id="oldPass" required="true">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control" id="confirmPassword" required="true" equalTo="#newPass" name="password_confirmation">
                    </div>
  ...
  <!--validition og password-->
  <script src="../../assets/js/application.js"></script>
  <script src="../../assets/js/jquery.password-validator.js"></script>
  <script src="../../assets/js/jquery.password-validation.js"></script>
  <script>
...
$('#btn-update').on('click', function(event){
  ...
  if($('#password').val() == $('#confirmPassword').val()){            
    ...
    var d = password.length;
      if (password.match(a) && password.match(b) && password.match(c) &&  d >= 8)  {   
        $.ajax({  
            url:"../ajax/tempPass.php",  
            type:"post",  
            data:{oldPass:oldPass,password:password},
            beforeSend: function(){
              $('#loading').show();
              $('#btn-update').hide();
            },    
            success:function(dataa){ 
              ...
              if (dataa == 'passIncorrect') {
                ...
                window.location.replace("changePassV.php");
              }else if(dataa == 'error'){
                Swal.fire(
                  'ERROR',
                  'Something wrong',
      ...
      Swal.fire(
        'INFO',
        'Password must atleast 8 chapters and contain letter with capital and small letter and number!',
        'info'
      )
    }
  }else{  
