              ...
              <form action="error404.php" method="post">
					...
					<div class="form-row">
                      ...
                      <div class="box-footer clearfix">
                        <button type="submit" class="pull-right btn btn-primary" name="newacc" id="sendEmail">Register
          ...
          <div class="box box-info">
            ...
            <!-- Content-->
              <form action="new_account.php" method="post">
                      ...
                      <div class="box-footer clearfix">
                        <button type="submit" class="pull-right btn btn-default" name="newacc" id="sendEmail">Register
                          <i class="fa fa-arrow-circle-up"></i></button>
                      </div>
