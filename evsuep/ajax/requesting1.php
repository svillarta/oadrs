...
if ($requesting =='refresh') {
	$sql = mysqli_query($conn,"SELECT * FROM s_request WHERE (remarks1='Paid' OR remarks1='Released')");
}else{
	$sql = mysqli_query($conn,"SELECT * FROM s_request WHERE srequest = '$requesting' AND remarks1='Paid'");
}
