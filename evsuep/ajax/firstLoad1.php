...
while ($row = mysqli_fetch_assoc($query)) {
  ...
  $count++;
  $sql = mysqli_query($conn,"SELECT * FROM s_request WHERE remarks1='Paid' AND sid='$sidA'");
  if (mysqli_num_rows($sql)>0) {
    ?>
    <tr>
      <td>
              ...
              <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
               <thead>
                <tr>
                  ...
                  <th>Remarks</th>
                  <th class="disabled-sorting "><center>
                    <b  class="btn btn btn-success btn-sm release" sid="<?php echo $sidA; ?>"><i class="material-icons">check_box</i> Release</b></center></th>
                </tr>
              </thead>
