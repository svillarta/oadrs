        ...
        <form action="#" method="post">
          ...
          <tbody>
            ...
            <?php
              ...
              <td width="40">
              <a class="btn btn-danger"<a onclick="return confirm('Are you sure you want to delete transaction ?');" href="error404.php<?php echo '?spid='.$spid; ?>"><i  class="fa fa-trash"></i></a>
              </td>
            <?php } ?>
              </tr>
              <?php }
