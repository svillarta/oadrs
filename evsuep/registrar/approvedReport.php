...
<body class="">
  ...
  <div class="wrapper ">
      ...
      <div class="sidebar-wrapper">
        ...
        <ul class="nav">
          ...
          <li class="nav-item active">
            <a class="nav-link" data-toggle="collapse" aria-expanded="true" href="#report">
    ...
    <div class="modal fade " id="requests" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby=" staticBackdropLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <input type="hidden" name="" id="modalSid">
          <div class="modal-body" id="studentRequestData">
...
<script type="text/javascript">
  ...
  $(document).on('click','.confirm',function(envent){
    ...
    $.ajax({  
        url:"../ajax/reqVerifyer.php",
        type:'post',
        data:{sid:sid,srid:srid,srequest:srequest},
        beforeSend: function(){
...
<script type="text/javascript">
  function studentRequest() {
    var sid = $('#modalSid').val();
    $.ajax({
         url:"../ajax/studentRequest.php",
         type:'post',
         data:{sid:sid},
          success:function(data3){
            $('#studentRequestData').html(data3);
         }
       });
  }
  

  $(document).on('click','#studentReq',function(envent){
    sid = jQuery(this).attr('sudentId');
    $('#modalSid').val(sid);
    studentRequest();
    $('#requests').modal('show');
  });
