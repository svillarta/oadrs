              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      <div class="input-group form-control-lg">
                        <label for="mi" class="bmd-label-floating">Middle Name (required)</label>
                  ...
                  <div class="row">
                    <div class="col">
                      <div class="input-group form-control-lg">
                        <label for="studentId" class="bmd-label-floating">Student ID (required)</label>
                        <input type="number" class="form-control" name="studentId" id="studentId" required="" >
                      </div>
                    </div>
                    <div class="col">
                      <div class="input-group form-control-lg">
                        <label for="studentId" class="bmd-label-floating">Contact Number (required)</label>
                        <input type="number" class="form-control" name="no" id="no" required="" >
                      </div>
                    </div>
                    <div class="col">
                      <div class="input-group form-control-lg">
                        <label for="studentId" class="bmd-label-floating">E-mail (required)</label>
                  ...
                  <div class="row">
                    <div class="col form-group ">
                      ...
                      <div class="dropdown">
                        <select class="form-control" name="department" id="department" data-size="7" data-style="select-with-transition" title="Single Select" tabindex="-98">
                          <option value="" selected="" disabled >Select Department</option>
                          <?php
                          $queryDep = mysqli_query($conn,"SELECT * FROM department");
                          while ($rowDep = mysqli_fetch_assoc($queryDep)) {
                              $dep = $rowDep['dep'];
                              ?>
                ...
                <div class="box-footer clearfix" >
                  <button class="pull-right btn btn-primary loading" type="button" disabled=""><i class="fa fa-spinner fa-spin"></i> Loading...</span></button>
    ...
    $.ajax({  
        ...
        success:function(dataa){ 
          ...
          if (dataa == 'error') {
             Swal.fire(
              'ERROR',
              'Somthing wrong with the data please check the information you input',
              'error'
            );
            
          }else if(dataa == 'studIdExist'){
            Swal.fire(
              'INFO',
            ...
            Swal.fire(
              'SUCCESS',
              'Data was save Please Virify your email and contact number',
              'success'
            );
