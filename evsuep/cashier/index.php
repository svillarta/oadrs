  ...
  <div class="wrapper ">
    ...
    <div class="main-panel">
     ...
     <div class="content">
      ...
      <!-- End Content -->
      <!-- Modal -->
      <div class="modal fade" id="payPrint"  tabindex="-1" ole="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        <div class="modal-dialog" role="document" id="mydivheader" style="cursor: move;">
          <div class="modal-content">
            <div class="modal-header"  >
              <h5 class="modal-title" id="exampleModalLongTitle">Draggable</h5>
            ...
            <div class="modal-body" id="printNow">
              
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary close1" data-dismiss="modal">Close</button>
              <button type="button" class="btn btn-primary" id="print"><span class="fa fa-print"></span> Print</button>
            </div>
          </div>
        </div>
      </div>
...
dragElement(document.getElementById("payPrint"));
