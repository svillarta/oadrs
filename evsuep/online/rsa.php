...
if(isset($_POST['regacc'])) {
	...
	if($cui > 0)
	{
		...
		$uid = $ui_row['uid'];
		$saveui = mysql_query("insert into online_account (uid,sid,lname,fname,mi,email,contactno)
		values ('$uid','$sid','$lastname','$firstname','$mi','$email','$contact')")or die(mysql_error());
	}
	echo "<script>
